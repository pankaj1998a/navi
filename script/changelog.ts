...
Generates UPCOMING_CHANGELOG.md by running the navi changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for navi run (default: low)
      --quiet            Suppress navi command output unless it fails
