...
export class Service extends Context.Service<Service, Interface>()("@navi/Image") {}
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.promise(async () => {
        try {
          ...
          ;(globalThis as typeof globalThis & { __NAVI_PHOTON_WASM_PATH?: string }).__NAVI_PHOTON_WASM_PATH =
            photonWasm
