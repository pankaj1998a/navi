 ...
 *   "@navi/ServerAuthConfig",
 *   {
 *     password: Config.string("NAVI_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("NAVI_SERVER_USERNAME").pipe(Config.withDefault("navi")),
 *   },
 * ) {}
 *
