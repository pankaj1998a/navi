...
export namespace Server {
    ...
    () =>
      ...
      app
        ...
        .get(
          ...
          describeRoute({
            summary: "Get health",
            description: "Get health information about the Navi server.",
        ...
        .get(
          ...
          describeRoute({
            ...
            description: "Subscribe to global events from the Navi system using server-sent events.",
        ...
        .post(
          ...
          describeRoute({
            ...
            description: "Clean up and dispose all Navi instances, releasing all resources.",
        ...
        .use(async (c, next) => {
          let directory = c.req.query("directory") || c.req.header("x-navi-directory") || process.cwd()
          try {
        ...
        .get(
          ...
          describeRoute({
            ...
            description: "Retrieve the current Navi configuration settings and preferences.",
        ...
        .patch(
          ...
          describeRoute({
            ...
            description: "Update Navi configuration settings and preferences.",
        ...
        .post(
          ...
          describeRoute({
            summary: "Dispose instance",
            description: "Clean up and dispose the current Navi instance, releasing all resources.",
        ...
        .get(
          ...
          describeRoute({
            summary: "Get paths",
            description:
              "Retrieve the current working directory and related path information for the Navi instance.",
        ...
        .get(
          ...
          describeRoute({
            ...
            description: "Get a list of all Navi sessions, sorted by most recently updated.",
        ...
        .get(
          ...
          describeRoute({
            summary: "Get session",
            description: "Retrieve detailed information about a specific Navi session.",
            tags: ["Session"],
        ...
        .post(
          ...
          describeRoute({
            ...
            description: "Create a new Navi session for interacting with AI assistants and managing conversations.",
        ...
        .get(
          ...
          describeRoute({
            ...
            description: "Get a list of all available commands in the Navi system.",
        ...
        .get(
          ...
          describeRoute({
            summary: "List agents",
            description: "Get a list of all available AI agents in the Navi system.",
        ...
        .all("/*", async (c) => {
          ...
          const response = await proxy(`https://app.navi.ai${path}`, {
            ...c.req,
            headers: {
              ...c.req.raw.headers,
              host: "app.navi.ai",
  ...
  export function listen(opts: { port: number; hostname: string; mdns?: boolean; cors?: string[] }) {
    ...
    if (shouldPublishMDNS) {
      MDNS.publish(server.port!, `navi-${server.port!}`)
    } else if (opts.mdns) {
