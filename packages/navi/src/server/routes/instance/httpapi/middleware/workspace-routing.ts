...
>()("@navi/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@navi/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.NAVI_WORKSPACE_ID ? WorkspaceID.make(Flag.NAVI_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-navi-directory"] || process.cwd()
}
