  ...
  new Hono()
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the current global Navi configuration settings and preferences.",
    ...
    .patch(
      ...
      describeRoute({
        ...
        description: "Update global Navi configuration settings and preferences.",
    ...
    .post(
      "/upgrade",
      describeRoute({
        summary: "Upgrade Navi",
        description: "Upgrade Navi to the specified version or latest if not specified.",
