...
export namespace Permission {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@navi/Permission") {}
    ...
    Effect.gen(function* () {
      const state = yield* InstanceState.make<State>(
        Effect.fn("Permission.state")(function* (ctx) {
          const row = yield* Effect.promise(() => JsonlStorage.readItem<any>("permissions", ctx.project.id))
          const state = {
      ...
      const reply = Effect.fn("Permission.reply")(function* (input: z.infer<typeof ReplyInput>) {
        ...
        yield* Effect.promise(() => JsonlStorage.writeItem("permissions", projectID, { data: approved }))
