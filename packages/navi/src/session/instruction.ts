...
export class Service extends Context.Service<Service, Interface>()("@navi/Instruction") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const globalFiles = [
      ...
      ...(!Flag.NAVI_DISABLE_CLAUDE_CODE_PROMPT ? [path.join(global.home, ".claude", "CLAUDE.md")] : []),
    ]
