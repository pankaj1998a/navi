...
import { sanitizedProcessEnv } from "@navi-ai/core/util/navi-process"
...
export class Service extends Context.Service<Service, Interface>()("@navi/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".navi")) continue
