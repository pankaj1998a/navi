...
import { Slug } from "@navi-ai/core/util/slug"
...
export class Service extends Context.Service<Service, Interface>()("@navi/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const startSync = Effect.fn("Workspace.startSync")(function* (space: Info) {
      if (!Flag.NAVI_EXPERIMENTAL_WORKSPACES) return
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        NAVI_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        NAVI_WORKSPACE_ID: config.id,
        NAVI_EXPERIMENTAL_WORKSPACES: "true",
