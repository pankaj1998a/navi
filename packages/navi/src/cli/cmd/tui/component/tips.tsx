...
const TIPS = [
  ...
  "Press {highlight}Tab{/highlight} to cycle between Build, Specs, Ask, and VibeMode agents",
  ...
  "Switch to {highlight}Specs{/highlight} agent to get suggestions without making actual changes",
  "Use {highlight}@agent-name{/highlight} in prompts to invoke specialized subagents",
  "Press {highlight}Ctrl+X Right/Left{/highlight} to cycle through parent and child sessions",
  "Create {highlight}navi.json{/highlight} in project root for project-specific settings",
  "Place settings in {highlight}~/.config/navi/navi.json{/highlight} for global config",
  ...
  "Navi auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.navi/tool/{/highlight} to define new LLM tools",
  ...
  "Use {highlight}navi run --continue{/highlight} to resume the last session",
  ...
  "Press {highlight}Ctrl+P{/highlight} and type {highlight}Git Status{/highlight} to manage your repository",
  "In Git Status, press {highlight}s{/highlight} to stage a file and {highlight}u{/highlight} to unstage",
  "Press {highlight}v{/highlight} on a file in Git Status to view its full diff",
  "Stage individual hunks by selecting a file in Git Status and pressing {highlight}s{/highlight} on hunks",
  "Enable {highlight}tui.scroll_acceleration{/highlight} for smooth macOS-style scrolling",
  "Toggle username display in chat via command palette ({highlight}Ctrl+P{/highlight})",
  "Run {highlight}docker run -it --rm ghcr.io/sst/navi{/highlight} for containerized use",
