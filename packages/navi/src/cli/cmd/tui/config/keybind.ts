...
const Definitions = {
  ...
  scrollbar_toggle: keybind("<leader>S,ctrl+alt+s", "Toggle session scrollbar"),
  ...
  messages_page_up: keybind("pageup,ctrl+alt+b,shift+pageup", "Scroll messages up by one page"),
  messages_page_down: keybind("pagedown,ctrl+alt+f,shift+pagedown", "Scroll messages down by one page"),
  messages_line_up: keybind("ctrl+alt+y,ctrl+up,alt+up,shift+up,alt+k", "Scroll messages up by one line"),
  messages_line_down: keybind("ctrl+alt+e,ctrl+down,alt+down,shift+down,alt+j", "Scroll messages down by one line"),
  messages_scroll_left: keybind("ctrl+alt+h,alt+h,shift+left", "Scroll messages left (side scroll)"),
  messages_scroll_right: keybind("ctrl+alt+l,alt+l,shift+right", "Scroll messages right (side scroll)"),
  messages_half_page_up: keybind("ctrl+alt+u,ctrl+u", "Scroll messages up by half page"),
  messages_half_page_down: keybind("ctrl+alt+d,ctrl+d", "Scroll messages down by half page"),
  ...
  buddy_list: keybind("<leader>B", "List buddies"),
