...
import type { TuiPlugin, TuiPluginApi, TuiPluginModule, TuiPluginStatus } from "@navi-ai/plugin/tui"
...
function state(api: TuiPluginApi, item: TuiPluginStatus) {
  ...
  return (
    <text fg={item.active ? api.theme.current.success : api.theme.current.error}>
