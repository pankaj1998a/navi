...
export const NaviKeymapProvider = KeymapProvider
export const useNaviKeymap = useKeymap
...
export function registerNaviKeymap(keymap: OpenTuiKeymap, renderer: CliRenderer, config: TuiConfig.Resolved) {
