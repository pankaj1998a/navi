...
import type { NaviClient, PermissionRequest, QuestionRequest, ToolPart } from "@navi-ai/sdk/v2"
...
type PromptModel = Parameters<NaviClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<NaviClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<NaviClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<NaviClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<NaviClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<NaviClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<NaviClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<NaviClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<NaviClient["question"]["reject"]>[0]
