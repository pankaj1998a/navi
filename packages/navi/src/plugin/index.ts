...
export class Service extends Context.Service<Service, Interface>()("@navi/Plugin") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("Plugin.state")(function* (ctx) {
        ...
        const plugins = Flag.NAVI_PURE ? [] : (cfg.plugin_origins ?? [])
        if (Flag.NAVI_PURE && cfg.plugin_origins?.length) {
