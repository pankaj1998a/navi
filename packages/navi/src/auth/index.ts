...
export class Service extends Context.Service<Service, Interface>()("@navi/Auth") {}
...
export async function get(providerID: string) {
  ...
  return AppRuntime.runPromise(Service.use((s) => s.get(providerID)))
}
...
export async function set(key: string, info: Info) {
  const { AppRuntime } = await import("@/effect/app-runtime")
  return AppRuntime.runPromise(Service.use((s) => s.set(key, info)))
}
