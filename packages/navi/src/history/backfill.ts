        ...
        db
          ...
          .where(
            and(
              ...
              sql`NOT EXISTS (SELECT 1 FROM navi_history_fts WHERE navi_history_fts.part_id = ${PartTable.id})`,
            ),
          )
...
export class Service extends Context.Service<Service, Interface>()("@navi/History.Backfill") {}
