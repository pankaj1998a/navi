...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips navi-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-navi-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-navi-directory")).toBeNull()
      expect(result.get("x-navi-workspace")).toBeNull()
