...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/navi.git")).toEqual({ owner: "sst", repo: "navi" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/navi")).toEqual({ owner: "sst", repo: "navi" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/navi.git")).toEqual({ owner: "sst", repo: "navi" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/navi")).toEqual({ owner: "sst", repo: "navi" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/navi.git")).toEqual({ owner: "sst", repo: "navi" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/navi")).toEqual({ owner: "sst", repo: "navi" })
})
