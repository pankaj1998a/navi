...
Practical reference for the current tool-migration state in `packages/navi`.
...
Tool tests should use the existing Effect helpers in `packages/navi/test/lib/effect.ts`:
