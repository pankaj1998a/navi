...
import { BaseDeclarativeTool, BaseToolInvocation, Kind, type ToolResult } from '../tools/tools.js';
import { PRDManager, type UserStory, StoryStatus } from './prd-manager.js';
...
PRD saved to prd.json. Run the autonomous loop to start execution.`,
...
The PRD is saved as prd.json with structured user stories that can be executed by the autonomous loop agent.
