...
import { base64Encode } from "@navi-ai/core/util/encode"
...
import { Session, type Message } from "@navi-ai/sdk/v2/client"
...
import { useTheme, type ColorScheme } from "@navi-ai/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://navi.ai/desktop-feedback")}
      renderPanel={() =>
