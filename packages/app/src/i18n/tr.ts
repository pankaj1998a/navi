...
export const dict = {
  ...
  "dialog.provider.navi.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.navi.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.naviGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Navi tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Navi'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.naviZen.line1":
    "Navi Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.naviZen.visit.prefix": "",
  "provider.connect.naviZen.visit.link": "navi.ai/zen",
  "provider.connect.naviZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Navi'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Navi'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler navi.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Navi sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Navi'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Navi ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (navi.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Navi henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Navi ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Navi Masaüstü",
  ...
  "settings.desktop.wsl.description": "Navi sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Navi'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Navi'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Navi'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Navi'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Navi başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Navi'un en son sürümünü kullanıyorsunuz.",
