...
export const dict = {
  ...
  "dialog.provider.navi.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.navi.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.naviGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Navi",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Navi.",
  ...
  "provider.connect.naviZen.line1":
    "Navi Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.naviZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.naviZen.visit.prefix": "Besøk ",
  "provider.connect.naviZen.visit.link": "navi.ai/zen",
  "provider.connect.naviZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Navi.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Navi.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i navi.json",
  ...
  "dialog.server.description": "Bytt hvilken Navi-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Navi ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Navi-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (navi.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Navi ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Navi inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Navi-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Navi",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Navi ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Navi skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Navi er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Navi starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Navi.",
