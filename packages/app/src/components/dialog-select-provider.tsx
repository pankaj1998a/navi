...
export const DialogSelectProvider: Component = () => {
  ...
  const note = (id: string) => {
    ...
    if (id === "navi-go") return language.t("dialog.provider.naviGo.tagline")
  }
      ...
      >
        {(i) => (
          <div class="px-1.25 w-full flex items-center gap-x-3">
            ...
            <span>{i.name}</span>
            <Show when={i.id === "navi"}>
              <div class="text-14-regular text-text-weak">{language.t("dialog.provider.navi.tagline")}</div>
            </Show>
