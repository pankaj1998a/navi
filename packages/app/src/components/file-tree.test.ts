...
beforeAll(async () => {
  ...
  mock.module("@navi-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@navi-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@navi-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@navi-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
