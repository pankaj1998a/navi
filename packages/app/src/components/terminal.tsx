...
import { resolveThemeVariant, useTheme, withAlpha, type HexColor } from "@navi-ai/ui/theme"
...
export const Terminal = (props: TerminalProps) => {
  ...
  onMount(async () => {
    ...
    if (window.__navi__?.serverPassword) {
      url.username = "navi"
      url.password = window.__navi__?.serverPassword
    }
