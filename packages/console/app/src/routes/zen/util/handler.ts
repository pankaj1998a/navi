...
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@navi-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@navi-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@navi-ai/console-core/util/date.js"
...
export async function handler(
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://navi.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://navi.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://navi.ai/workspace/${authInfo.workspaceID}/members`
