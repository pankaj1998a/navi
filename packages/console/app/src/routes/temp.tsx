    ...
    <main data-page="home">
      ...
      <div data-component="content">
        ...
        <footer data-component="footer">
          <div data-slot="cell">
            <a href="https://x.com/navi">{i18n.t("footer.x")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://github.com/anomalyco/navi">{i18n.t("footer.github")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://navi.ai/discord">{i18n.t("footer.discord")}</a>
          </div>
        </footer>
      </div>
