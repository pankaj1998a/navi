        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <h2 id="what-is-navi">What is Navi?</h2>
              <p>
                Navi is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Navi Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Navi enables you to
              ...
              <p>
                ...
                our site located at navi.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                Navi takes the privacy of its users very seriously. For the current Navi Privacy Policy, please
                click here{" "}
                <a href="https://navi.ai/legal/privacy-policy">https://navi.ai/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using Navi?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Navi;
                </li>
                <li>
              ...
              <p>
                If you use Navi with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Navi. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Navi has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-navi-ever-change-the-services">Will Navi ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href="https://navi.ai/auth">https://navi.ai/auth</a>.
              </p>
              ...
              <p>
                Navi is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. Navi has the sole right to decide whether you are
              ...
              <p>
                Navi and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Navi and all such
                parties together, the "Navi Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the Navi Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Navi Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Navi's prior written
              ...
              <p>
                ...
                disputes and claims with Navi and limits the manner in which you can seek relief from Navi. Both
                you and Navi acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, Navi's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Navi will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. Navi will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or Navi may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                Navi is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Navi to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Navi agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the Navi may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Navi agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and Navi, and
                ...
                are not an employee, agent, partner, or joint venture of Navi, and you do not have any authority of
                any kind to bind Navi in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and Navi
