...
export default function PrivacyPolicy() {
  return (
    <main data-page="legal">
      <Title>Navi | Privacy Policy</Title>
      <Link rel="canonical" href={`${config.baseUrl}/legal/privacy-policy`} />
      <Meta name="description" content="Navi privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At Navi, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of Navi is at all times subject to our Terms of Use,{" "}
                <a href="/legal/terms-of-service">https://navi.ai/legal/terms-of-service</a>, which incorporates
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the Navi website, by sending you
              ...
              <ul>
                <li>
                  ...
                  sending you information about Navi.
                </li>
              ...
              <p>
                ...
                you, Navi or another party; enforcing any agreements with you; responding to claims that any posting
