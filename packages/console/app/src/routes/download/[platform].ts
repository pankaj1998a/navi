...
const assetNames: Record<string, string> = {
  "darwin-aarch64-dmg": "navi-desktop-darwin-aarch64.dmg",
  "darwin-x64-dmg": "navi-desktop-darwin-x64.dmg",
  "windows-x64-nsis": "navi-desktop-windows-x64.exe",
  "linux-x64-deb": "navi-desktop-linux-amd64.deb",
  "linux-x64-appimage": "navi-desktop-linux-amd64.AppImage",
...
export async function GET({ params: { platform } }: APIEvent) {
  ...
  const resp = await fetch(`https://github.com/anomalyco/navi/releases/latest/download/${assetName}`, {
    cf: {
