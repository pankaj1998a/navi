...
import copyLogoSvgLight from "../asset/lander/navi-logo-light.svg"
import copyLogoSvgDark from "../asset/lander/navi-logo-dark.svg"
import copyWordmarkSvgLight from "../asset/lander/navi-wordmark-light.svg"
import copyWordmarkSvgDark from "../asset/lander/navi-wordmark-dark.svg"
  ...
  return (
    <section data-component="top">
      <div onContextMenu={handleLogoContextMenu}>
        <A href="/">
          <img data-slot="logo light" src={logoLight} alt="navi logo light" width="189" height="34" />
          <img data-slot="logo dark" src={logoDark} alt="navi logo dark" width="189" height="34" />
        </A>
      </div>
