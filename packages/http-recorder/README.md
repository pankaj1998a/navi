...
Internal package; depended on as `@navi-ai/http-recorder` from another
workspace package.

```ts
import { HttpRecorder } from "@navi-ai/http-recorder"
```
...
```ts
import { HttpRecorder, Redactor } from "@navi-ai/http-recorder"
