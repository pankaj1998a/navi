...
import type {
  ...
  EventTuiSentryActive,
  EventTuiSentryFixCompleted,
  EventTuiSessionSelect,
  EventTuiToastShow,
  ExperimentalBusReplayResponses,
  ExperimentalResourceListResponses,
  ExperimentalSessionListResponses,
  ExperimentalSessionRewindErrors,
  ExperimentalSessionRewindResponses,
  ExperimentalVoiceCaptureResponses,
...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new NaviClient()" to fix this error.`)
    }
    return instance
  }
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Navi configuration settings and preferences.
   */
   ...
   *
   * Update global Navi configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Navi server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Navi system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Navi instances, releasing all resources.
   */
   ...
   * Upgrade Navi
   *
   * Upgrade Navi to the specified version or latest if not specified.
   */
  ...
  syncEvent = new SyncEvent({ client: this.client })
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Navi system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Navi system.
   */
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Navi.
   */
   ...
   * Get current project
   *
   * Retrieve the currently active project that Navi is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Navi.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session extends HeyApiClient {
   ...
   * Rewind session
   *
   * Removes the last N messages from a session history
   */
  public rewind<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<
      ...
      ThrowOnError
    >({
      url: "/experimental/session/rewind",
      ...options,
      ...params,
      headers: {
        "Content-Type": "application/json",
   ...
   * Create session
   *
   * Create a new Navi session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Navi session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Voice extends HeyApiClient {
   ...
   *
   * Starts or stops native microphone recording using VoiceService. When stopping, returns the transcribed text.
   */
  public capture<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<ExperimentalVoiceCaptureResponses, unknown, ThrowOnError>({
      url: "/experimental/voice/capture",
      ...options,
      ...params,
      headers: {
        "Content-Type": "application/json",
...
export class Bus extends HeyApiClient {
  /**
   * Replay events
   *
   * Replays events from the persistent store for a given context (e.g. sessionID).
   */
      ...
      [
        {
          args: [
            { in: "query", key: "directory" },
            { in: "query", key: "workspace" },
            { in: "query", key: "contextId" },
          ],
        },
      ],
    )
    return (options?.client ?? this.client).get<ExperimentalBusReplayResponses, unknown, ThrowOnError>({
      url: "/experimental/bus/replay",
      ...options,
      ...params,
    })
  }
...
export class Experimental extends HeyApiClient {
  ...
  bus = new Bus({ client: this.client })
}
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Navi instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Navi system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class NaviClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<NaviClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    NaviClient.__registry.set(this, args?.key)
  }
