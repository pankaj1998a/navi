---
title: Zen
description: Utvalgt liste over modeller levert av Navi.
---
...
Navi Zen er en liste over testede og verifiserte modeller levert av Navi-teamet.

:::note
Navi Zen er for øyeblikket i beta.
:::

Zen fungerer som enhver annen leverandør i Navi. Du logger inn på Navi Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Navi.
:::
...
Navi Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Navi Zen fungerer som enhver annen leverandør i Navi.

1. Du logger inn på **<a href={console}>Navi Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger Navi Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i Navi-konfigurasjonen din
bruker formatet `Navi/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `Navi/gpt-5.5` i konfigurasjonen din.
...
- MiniMax M2.5 Free er tilgjengelig på Navi i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Ring 2.6 1T Free er tilgjengelig på Navi i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Super Free er tilgjengelig på Navi i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Navi i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med Navi også.
