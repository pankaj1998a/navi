---
title: TUI
description: Bruke Navi-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Navi gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Navi starter TUI for gjeldende katalog.
...
Når du bruker Navi TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Navi. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Dette er atskilt fra `Navi.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `Navi_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
