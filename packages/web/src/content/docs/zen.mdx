...
| MiniMax M2.1       | minimax-m2.1-free  | `https://navi.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Gemini 3 Pro       | gemini-3-pro       | `https://navi.ai/zen/v1/models/gemini-3-pro`   | `@ai-sdk/google`            |
| Gemini 3 Flash     | gemini-3-flash     | `https://navi.ai/zen/v1/models/gemini-3-flash` | `@ai-sdk/google`            |
| GLM 4.6            | glm-4.6            | `https://navi.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.7            | glm-4.7-free       | `https://navi.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2            | kimi-k2            | `https://navi.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2 Thinking   | kimi-k2-thinking   | `https://navi.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3 Coder 480B   | qwen3-coder        | `https://navi.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Grok Code Fast 1   | grok-code          | `https://navi.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
uses the format `navi/<model-id>`. For example, for GPT 5.1 Codex, you would
use `navi/gpt-5.4-codex` in your config.
...
- Grok Code Fast 1 is currently free on Navi for a limited time. The xAI team is using this time to collect feedback and improve Grok Code.
- GLM 4.7 is currently free on Navi for a limited time. The team is using this time to collect feedback and improve the model.
- MiniMax M2.1 is currently free on Navi for a limited time. The team is using this time to collect feedback and improve the model.
