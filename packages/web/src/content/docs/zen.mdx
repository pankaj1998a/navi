---
title: Zen
description: Curated list of models provided by Navi.
---
...
Navi Zen is a list of tested and verified models provided by the Navi team.

:::note
Navi Zen is currently in beta.
:::

Zen works like any other provider in Navi. You login to Navi Zen and get
...
:::tip
We tested a select group of models and providers that work well with Navi.
:::
...
Navi Zen is an AI gateway that gives you access to these models.

---

## How it works

Navi Zen works like any other provider in Navi.

1. You sign in to **<a href={console}>Navi Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select Navi Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your Navi config
uses the format `Navi/<model-id>`. For example, for GPT 5.5, you would
use `Navi/gpt-5.5` in your config.
...
- MiniMax M2.5 Free is available on Navi for a limited time. The team is using this time to collect feedback and improve the model.
- Ring 2.6 1T Free is available on Navi for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Super Free is available on Navi for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on Navi for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with Navi as well.
