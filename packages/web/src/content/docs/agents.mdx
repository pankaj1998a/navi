...
Navi comes with two built-in subagents, **General** and **Explore**. We'll look at this below.

---

## Built-in

Navi comes with two built-in primary agents and two built-in subagents.
...
- Global: `~/.config/navi/agent/`
- Per-project: `.navi/agent/`

```markdown title="~/.config/navi/agent/review.md"
---
...
```markdown title="~/.config/navi/agent/docs-writer.md"
---
...
```markdown title="~/.config/navi/agent/security-auditor.md"
---
