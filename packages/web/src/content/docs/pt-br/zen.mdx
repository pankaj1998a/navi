---
title: Zen
description: Lista selecionada de modelos fornecidos pelo Navi.
---
...
O Navi Zen é uma lista de modelos testados e verificados fornecidos pela equipe do Navi.

:::note
O Navi Zen está atualmente em beta.
:::

O Zen funciona como qualquer outro provedor no Navi. Você faz login no Navi Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o Navi.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o Navi.
:::
...
O Navi Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O Navi Zen funciona como qualquer outro provedor no Navi.

1. Você faz login no **<a href={console}>Navi Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona Navi Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do Navi usa o formato `Navi/<model-id>`. Por exemplo, para GPT 5.5, você usaria `Navi/gpt-5.5` na sua configuração.
...
- MiniMax M2.5 Free está disponível no Navi por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Ring 2.6 1T Free está disponível no Navi por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Super Free está disponível no Navi por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no Navi por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o Navi também.
