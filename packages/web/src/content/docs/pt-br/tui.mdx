---
title: TUI
description: Usando a interface de usuário de terminal Navi.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O Navi fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar Navi inicia o TUI para o diretório atual.
...
Ao usar o TUI do Navi, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao Navi. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Isso é separado do `Navi.json`, que configura o comportamento do servidor/runtime.
...
Use `Navi_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
