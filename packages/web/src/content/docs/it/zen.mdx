---
title: Zen
description: Lista curata di modelli fornita da Navi.
---
...
Navi Zen è un elenco di modelli testati e verificati forniti dal team di Navi.

:::note
Navi Zen è attualmente in beta.
:::

Zen funziona come qualsiasi altro provider in Navi. Accedi a Navi Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Navi.
:::
...
Navi Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

Navi Zen funziona come qualsiasi altro provider in Navi.

1. Accedi a **<a href={console}>Navi Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Navi Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di Navi
usa il formato `Navi/<model-id>`. Per esempio, per GPT 5.5, useresti
`Navi/gpt-5.5` nella tua config.
...
- MiniMax M2.5 Free è disponibile su Navi per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Ring 2.6 1T Free è disponibile su Navi per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Super Free è disponibile su Navi per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su Navi per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con Navi.
