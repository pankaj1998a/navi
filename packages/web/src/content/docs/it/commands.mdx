...
Puoi aggiungere comandi personalizzati tramite la config di Navi o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Navi:
...
- Globale: `~/.config/Navi/commands/`
- Per progetto: `.Navi/commands/`
...
Navi include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
