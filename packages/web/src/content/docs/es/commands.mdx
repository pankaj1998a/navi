...
Puede agregar comandos personalizados a través de la configuración Navi o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Navi [config](/docs/config):
...
Navi incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
