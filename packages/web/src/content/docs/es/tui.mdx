---
title: TUI
description: Usando la interfaz de usuario del terminal Navi.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Navi proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Navi se inicia TUI para el directorio actual.
...
Cuando utilice Navi TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Navi. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Esto es independiente de `Navi.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `Navi_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
