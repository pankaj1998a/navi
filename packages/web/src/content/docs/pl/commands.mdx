...
Możesz zdefiniować polecenia w `Navi.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji Navi:
...
- Globalnie: `~/.config/Navi/commands/`
- Na projekt: `.Navi/commands/`
...
Navi zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
