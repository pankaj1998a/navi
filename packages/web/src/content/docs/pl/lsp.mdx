---
title: Serwery LSP
description: Navi integruje się z serwerami LSP.
---

Navi integruje się z protokołem Language Server Protocol (LSP), aby zapewnić modelom LLM kontekst bazy kodu. Wykorzystuje diagnostykę, aby przekazywać informacje zwrotne do LLM.

---

## Wbudowane

Navi posiada kilka wbudowanych serwerów LSP dla następujących języków:
...
:::note
Możesz wyłączyć automatyczne pobieranie serwerów LSP, ustawiając zmienną środowiskową `Navi_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Możesz dostosować serwery LSP poprzez sekcję `lsp` w konfiguracji Navi.
