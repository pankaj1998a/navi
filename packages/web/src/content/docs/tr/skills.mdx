...
Ajan becerileri, Navi'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
Navi su konumlari tarar:

- Proje konfigurasyonu: `.Navi/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/Navi/skills/<name>/SKILL.md`
...
Proje yerel yollarinda Navi, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.Navi/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/Navi/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.Navi/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
Navi, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`Navi.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`Navi.json` icinde):
