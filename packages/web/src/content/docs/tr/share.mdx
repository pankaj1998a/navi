---
title: Paylasim
description: Navi konusmalarini genel baglantilarla paylasin.
---

Navi'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda Navi:
...
Navi, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak Navi manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `Navi.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda Navi kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
