---
title: Özel Araçlar
description: LLM'un Navi'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. Navi'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.Navi/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/Navi/tools/` içine yerleştirerek.
