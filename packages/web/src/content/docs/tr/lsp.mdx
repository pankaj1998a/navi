...
description: Navi, LSP sunucularınızla bütünleşir.
---

Navi, LLM'in kod tabanınızla etkileşime girmesine yardımcı olmak için Dil Sunucusu Protokolünüzle (LSP) bütünleşir. LLM'ye geri bildirim sağlamak için tanılamayı kullanır.

---

## Yerleşik

Navi, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
:::note
`Navi_DISABLE_LSP_DOWNLOAD` ortam değişkenini `true` olarak ayarlayarak otomatik LSP sunucu indirmelerini devre dışı bırakabilirsiniz.
:::
...
LSP sunucularını, Navi yapılandırmanızdaki `lsp` bölümü aracılığıyla özelleştirebilirsiniz.
