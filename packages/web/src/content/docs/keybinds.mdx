...
Navi has a list of keybinds that you can customize through the Navi config.
...
Navi uses a `leader` key for most keybinds. This avoids conflicts in your terminal.
