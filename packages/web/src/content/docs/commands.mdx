...
Create `.navi/command/test.md`:

```md title=".navi/command/test.md"
---
...
You can add custom commands through the Navi config or by creating markdown files in the `command/` directory.
...
- Global: `~/.config/navi/command/`
- Per-project: `.navi/command/`

```markdown title="~/.config/navi/command/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".navi/command/component.md"
---
...
```md title=".navi/command/create-file.md"
---
...
```md title=".navi/command/analyze-coverage.md"
---
...
```md title=".navi/command/review-changes.md"
---
...
```md title=".navi/command/review-component.md"
---
