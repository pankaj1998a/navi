...
Vous pouvez ajouter des commandes personnalisées via la configuration Navi ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre Navi [config](/docs/config) :
...
Navi comprend plusieurs commandes intégrées comme `/init`, `/undo`, `/redo`, `/share`, `/help` ; [en savoir plus](/docs/tui#commands).
