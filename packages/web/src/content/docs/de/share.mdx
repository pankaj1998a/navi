---
title: Teilen
description: Teile Navi-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Navi-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Navi Folgendes:
...
Navi hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Navi den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`Navi.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du Navi in deiner Organisation einsetzt.
