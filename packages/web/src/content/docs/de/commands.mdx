...
Erstellen Sie `.Navi/commands/test.md`:

```md title=".Navi/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Navi-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Navi [config](/docs/config):

```json title="Navi.jsonc" {4-12}
{
...
- Global: `~/.config/Navi/commands/`
- Pro Projekt: `.Navi/commands/`

```markdown title="~/.config/Navi/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".Navi/commands/component.md"
---
...
```md title=".Navi/commands/create-file.md"
---
...
```md title=".Navi/commands/analyze-coverage.md"
---
...
```md title=".Navi/commands/review-changes.md"
---
...
```md title=".Navi/commands/review-component.md"
---
...
Navi enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
