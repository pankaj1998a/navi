---
title: TUI
description: Arbeite mit Navi in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Navi bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Navi die TUI im aktuellen Verzeichnis.
...
In der Navi-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu Navi hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Dies ist getrennt von `Navi.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `Navi_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
