---
title: Zen
description: Kuratierte Modellliste direkt von Navi.
---
...
Navi Zen ist eine Liste von getesteten und verifizierten Modellen, die vom Navi-Team bereitgestellt wird.

:::note
Navi Zen befindet sich derzeit in der Beta.
:::

Zen funktioniert wie jeder andere Provider in Navi. Du meldest dich bei Navi Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um Navi zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit Navi funktionieren.
:::
...
Navi Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

Navi Zen funktioniert wie jeder andere Provider in Navi.

1. Du meldest dich bei **<a href={console}>Navi Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst Navi Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner Navi-Konfiguration verwendet das Format `Navi/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `Navi/gpt-5.5` in deiner Konfiguration verwenden.
...
- MiniMax M2.5 Free ist für begrenzte Zeit auf Navi verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Ring 2.6 1T Free ist für begrenzte Zeit auf Navi verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Super Free ist für begrenzte Zeit auf Navi verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf Navi verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben Navi Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit Navi auch jeden anderen Provider zu verwenden.
