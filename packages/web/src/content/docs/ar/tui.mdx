---
title: TUI
description: استخدام واجهة المستخدم TUI في Navi.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Navi واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Navi إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Navi في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Navi. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Navi. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات Navi.
...
استخدم `Navi_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
