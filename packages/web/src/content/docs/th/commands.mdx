...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Navi:
...
- ระดับผู้ใช้ (Global): `~/.config/Navi/commands/`
- ระดับโปรเจ็กต์: `.Navi/commands/`
...
Navi มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
