...
description: What's new in Navi 1.0.
---

Navi 1.0 is a complete rewrite of the TUI.
...
The new TUI works like the old one since it connects to the same navi server.
...
version. However some older versions of Navi always grab latest.
