...
Možete dodati prilagođene komande kroz Navi konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Navi [config](/docs/config):
...
- Globalno: `~/.config/Navi/commands/`
- Po projektu: `.Navi/commands/`
...
Navi uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
