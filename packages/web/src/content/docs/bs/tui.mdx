---
title: TUI
description: Korištenje korisničkog interfejsa Navi terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Navi pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Navi pokreće TUI za trenutni direktorij.
...
Kada koristite Navi TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Navi. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Navi. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `Navi.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `Navi_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
