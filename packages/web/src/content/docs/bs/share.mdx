---
title: Dijeljenje
description: Dijelite Navi razgovore javnim linkovima.
---

Navi opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
Navi podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Ručno (zadano)

Po defaultu, Navi koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `Navi.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju Navi u organizaciji.
