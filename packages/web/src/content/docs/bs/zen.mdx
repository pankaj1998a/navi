---
title: Zen
description: Kurirana lista modela koje nudi Navi.
---
...
Navi Zen je lista testiranih i provjerenih modela koje pruža Navi tim.

:::note
Navi Zen je trenutno u beta fazi.
:::

Zen radi kao i svaki drugi provajder u Navi. Prijavite se na Navi Zen i
preuzmete svoj API ključ. To je **potpuno opcionalno** i ne morate ga koristiti
da biste koristili Navi.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s Navi.
:::
...
Navi Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

Navi Zen radi kao i svaki drugi provajder u Navi.

1. Prijavite se na **<a href={console}>Navi Zen</a>**, dodajte podatke za
   naplatu i kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI, izaberite Navi Zen i zalijepite svoj API ključ.
...
[model id](/docs/config/#models) u vašoj Navi konfiguraciji koristi format
`Navi/<model-id>`. Na primjer, za GPT 5.5 u konfiguraciji biste
koristili `Navi/gpt-5.5`.
...
- MiniMax M2.5 Free je dostupan na Navi ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Ring 2.6 1T Free je dostupan na Navi ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3 Super Free je dostupan na Navi ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Big Pickle je stealth model koji je besplatan na Navi ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
...
4. Obezbijedimo **bez lock-ina** time što vam omogućavamo da ga koristite s bilo kojim drugim coding agentom. I da vam uvijek omogućimo da koristite bilo koji drugi provajder i u Navi.
