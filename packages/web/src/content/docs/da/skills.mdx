...
Agentferdigheter lar Navi oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
Navi søker etter disse stedene:

- Prosjektkonfigurasjon: `.Navi/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/Navi/skills/<name>/SKILL.md`
...
For prosjektlokale stier går Navi opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.Navi/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/Navi/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.Navi/skills/git-release/SKILL.md` slik:
...
Navi viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `Navi.json`:
...
**For innebygde agenter** (i `Navi.json`):
