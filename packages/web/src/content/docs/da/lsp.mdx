---
title: LSP-servere
description: Navi integreres med dine LSP-servere.
---

Navi integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

Navi leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `Navi_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din Navi-konfiguration.
