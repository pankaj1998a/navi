---
title: TUI
description: Brug af Navi-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Navi giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Navi starter TUI for den nuværende mappe.
...
Når du bruger Navi TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Navi. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Dette er adskilt fra `Navi.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `Navi_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
