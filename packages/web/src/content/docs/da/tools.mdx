...
Her er alle de innebygde verktøyene som er tilgængelige i Navi.
...
:::note
Dette verktøyet er bare tilgængelig når `Navi_EXPERIMENTAL_LSP_TOOL=true` (eller `Navi_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger Navi-leverandøren eller når miljøvariabelen `Navi_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
