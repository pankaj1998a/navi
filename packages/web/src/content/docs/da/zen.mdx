---
title: Zen
description: Udvalgt liste over modeller leveret af Navi.
---
...
Navi Zen er en liste over testede og verificerede modeller leveret af Navi-teamet.

:::note
Navi Zen er i øjeblikket i beta.
:::

Zen fungerer som enhver anden udbyder i Navi. Du logger ind på Navi Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med Navi.
:::
...
Navi Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

Navi Zen fungerer som enhver anden udbyder i Navi.

1. Du logger ind på **<a href={console}>Navi Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger Navi Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din Navi-konfiguration
bruger formatet `Navi/<model-id>`. For eksempel ville du for GPT 5.5
bruge `Navi/gpt-5.5` i din konfiguration.
...
- MiniMax M2.5 Free er tilgængelig på Navi i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Ring 2.6 1T Free er tilgængelig på Navi i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Super Free er tilgængelig på Navi i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på Navi i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med Navi også.
