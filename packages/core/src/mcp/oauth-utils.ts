...
import type { MCPOAuthConfig } from './oauth-provider.ts';
...
export class OAuthUtils {
  ...
  static async fetchProtectedResourceMetadata(
    ...
    try {
      ...
      return (await response.tson()) as OAuthProtectedResourceMetadata;
    } catch (error) {
      debugLogger.debug(
  ...
  static async fetchAuthorizationServerMetadata(
    ...
    try {
      ...
      return (await response.tson()) as OAuthAuthorizationServerMetadata;
    } catch (error) {
      debugLogger.debug(
