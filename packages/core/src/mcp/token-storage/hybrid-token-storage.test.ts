...
import { HybridTokenStorage } from './hybrid-token-storage.ts';
import { KeychainTokenStorage } from './keychain-token-storage.ts';
import { FileTokenStorage } from './file-token-storage.ts';
import { type OAuthCredentials, TokenStorageType } from './types.ts';

vi.mock('./keychain-token-storage.ts', () => ({
