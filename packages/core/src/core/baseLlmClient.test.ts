...
import { BaseLlmClient, type GenerateJsonOptions } from './baseLlmClient.ts';
...
import type { GenerateContentOptions } from './baseLlmClient.ts';
import type { GenerateContentResponse } from '@google/genai';
import type { Config } from '../config/config.ts';
import { AuthType } from './contentGenerator.ts';
import { reportError } from '../util/errorReporting.ts';
import { logMalformedJsonResponse } from '../telemetry/loggers.ts';
import { retryWithBackoff } from '../util/retry.ts';
import { MalformedJsonResponseEvent } from '../telemetry/types.ts';
import { getErrorMessage } from '../util/errors.ts';
import type { ModelConfigService } from '../services/modelConfigService.ts';
import { makeResolvedModelConfig } from '../services/modelConfigServiceTestUtils.ts';

vi.mock('../util/errorReporting.ts');
vi.mock('../telemetry/loggers.ts');
vi.mock('../util/errors.ts', async (importOriginal) => {
  const actual = await importOriginal<typeof import('../util/errors.ts')>();
  return {
    ...actual,
