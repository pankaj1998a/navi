...
import { toParts } from '../code_assist/converter.ts';
import { createUserContent, FinishReason } from '@google/genai';
import { retryWithBackoff, isRetryableError } from '../util/retry.ts';
...
import { hasCycleInSchema } from '../tools/tools.ts';
import type { StructuredError } from './turn.ts';
import type { CompletedToolCall } from './coreToolScheduler.ts';
import {
  logContentRetry,
...
import { isFunctionResponse } from '../util/messageInspectors.ts';
import { partListUnionToString } from './geminiRequest.ts';
import type { ModelConfigKey } from '../services/modelConfigService.ts';
import { estimateTokenCountSync } from '../util/tokenCalculation.ts';
import {
  applyModelSelection,
