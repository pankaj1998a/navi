...
import { createCodeAssistContentGenerator } from '../code_assist/codeAssist.ts';
import { GoogleGenAI } from '@google/genai';
import type { Config } from '../config/config.ts';
import { LoggingContentGenerator } from './loggingContentGenerator.ts';
import { loadApiKey } from './apiKeyCredentialStorage.ts';
import { FakeContentGenerator } from './fakeContentGenerator.ts';
import { RecordingContentGenerator } from './recordingContentGenerator.ts';

vi.mock('../code_assist/codeAssist.ts');
vi.mock('@google/genai');
vi.mock('./apiKeyCredentialStorage.ts', () => ({
  loadApiKey: vi.fn(),
}));

vi.mock('./fakeContentGenerator.ts');
