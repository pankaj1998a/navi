...
import type {
  ConversationRecord,
  ToolCallRecord,
} from './chatRecordingService.ts';
import { ChatRecordingService } from './chatRecordingService.ts';
import type { Config } from '../config/config.ts';
import { getProjectHash } from '../util/paths.ts';
...
describe('ChatRecordingService', () => {
  ...
  describe('initialize', () => {
    ...
    it('should resume from an existing session if provided', () => {
      ...
      chatRecordingService.initialize({
        filePath: '/test/project/root/.gemini/tmp/chats/session.tson',
        conversation: {
          sessionId: 'old-session-id',
  ...
  describe('deleteSession', () => {
    it('should delete the session file', () => {
      ...
      expect(unlinkSyncSpy).toHaveBeenCalledWith(
        '/test/project/root/.gemini/tmp/chats/test-session-id.tson',
      );
    });
  });
