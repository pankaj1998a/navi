...
import { type Status } from '../core/coreToolScheduler.ts';
import { type ThoughtSummary } from '../util/thoughtUtils.ts';
...
import type { ToolResultDisplay } from '../tools/tools.ts';
...
export class ChatRecordingService {
  ...
  deleteSession(sessionId: string): void {
    try {
      ...
      const sessionPath = path.join(chatsDir, `${sessionId}.tson`);
