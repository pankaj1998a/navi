...
import * as memoryDiscovery from '../util/memoryDiscovery.ts';
import type { Config } from '../config/config.ts';
import { coreEvents, CoreEvent } from '../util/events.ts';

// Mock memoryDiscovery module
vi.mock('../util/memoryDiscovery.ts', async (importOriginal) => {
  const actual =
    await importOriginal<typeof import('../util/memoryDiscovery.ts')>();
  return {
    ...actual,
