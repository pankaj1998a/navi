...
import type { GeminiChat } from '../core/geminiChat.ts';
import { type ChatCompressionInfo, CompressionStatus } from '../core/turn.ts';
import { tokenLimit } from '../core/tokenLimits.ts';
import { getCompressionPrompt } from '../core/prompts.ts';
import { getResponseText } from '../util/partUtils.ts';
import { logChatCompression } from '../telemetry/loggers.ts';
import { makeChatCompressionEvent } from '../telemetry/types.ts';
import { getInitialChatHistory } from '../util/environmentContext.ts';
...
import { PreCompressTrigger } from '../hooks/types.ts';
