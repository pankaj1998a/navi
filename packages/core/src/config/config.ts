...
import { canUseRipgrep, RipGrepTool } from '../tools/ripGrep.ts';
import { GlobTool } from '../tools/glob.ts';
import { ActivateSkillTool } from '../tools/activate-skill.ts';
...
import { MemoryTool, setGeminiMdFilename } from '../tools/memoryTool.ts';
import { MemorySearchTool } from '../tools/memory-search.ts';
import { BrowserTool } from '../tools/browser.ts';
import { CodeSandboxTool } from '../tools/sandbox.ts';
import { SendMessageTool } from '../tools/send-message.ts';
import { TavilySearchTool } from '../tools/tavily.ts';
import { ExaSearchTool } from '../tools/exa.ts';
import { DuckDuckGoSearchTool } from '../tools/duckduckgo.ts';
import { FirecrawlTool } from '../tools/firecrawl.ts';
import { WebSearchTool } from '../tools/web-search.ts';
import { GeminiClient } from '../core/client.ts';
import { BaseLlmClient } from '../core/baseLlmClient.ts';
import type { HookDefinition, HookEventName } from '../hooks/types.ts';
import { FileDiscoveryService } from '../services/fileDiscoveryService.ts';
import { GitService } from '../services/gitService.ts';
import type { TelemetryTarget } from '../telemetry/index.ts';
import {
  initializeTelemetry,
...
import { tokenLimit } from '../core/tokenLimits.ts';
import {
...
import { shouldAttemptBrowserLaunch } from '../util/browser.ts';
import type { MCPOAuthConfig } from '../mcp/oauth-provider.ts';
import { ideContextStore } from '../ide/ideContext.ts';
import { WriteTodosTool } from '../tools/write-todos.ts';
import { MapCodebaseTool } from '../tools/map-codebase.ts';
import { PlanPhaseTool } from '../tools/plan-phase.ts';
import { ExecutePhaseTool } from '../tools/execute-phase.ts';
import { VerifyWorkTool } from '../tools/verify-work.ts';
import { ThinkTool } from '../tools/think-tool.ts';
import { CalculatorTool } from '../tools/calculator-tool.ts';
import { TimeTool } from '../tools/time-tool.ts';
import type { FileSystemService } from '../services/fileSystemService.ts';
import { StandardFileSystemService } from '../services/fileSystemService.ts';
import { logRipgrepFallback, logFlashFallback } from '../telemetry/loggers.ts';
import {
  RipgrepFallbackEvent,
  FlashFallbackEvent,
} from '../telemetry/types.ts';
import type { FallbackModelHandler } from '../fallback/types.ts';
import { ModelAvailabilityService } from '../availability/modelAvailabilityService.ts';
import { ModelRouterService } from '../routing/modelRouterService.ts';
import { OutputFormat } from '../output/types.ts';
import type {
  ModelConfig,
  ModelConfigServiceConfig,
} from '../services/modelConfigService.ts';
import { ModelConfigService } from '../services/modelConfigService.ts';
import { DEFAULT_MODEL_CONFIGS } from './defaultModelConfigs.ts';
import { ContextManager } from '../services/contextManager.ts';
import type { GenerateContentParameters } from '@google/genai';

import type { AnyToolInvocation } from '../tools/tools.ts';
export type { MCPOAuthConfig, AnyToolInvocation };
import { WorkspaceContext } from '../util/workspaceContext.ts';
import { Storage } from './storage.ts';
import type { ShellExecutionConfig } from '../services/shellExecutionService.ts';
import { FileExclusions } from '../util/ignorePatterns.ts';
import type { EventEmitter } from 'node:events';
import { MessageBus } from '../confirmation-bus/message-bus.ts';
import { PolicyEngine } from '../policy/policy-engine.ts';
import { ApprovalMode, type PolicyEngineConfig } from '../policy/types.ts';
import { HookSystem } from '../hooks/index.ts';
import type { UserTierId } from '../code_assist/types.ts';
import type { RetrieveUserQuotaResponse } from '../code_assist/types.ts';
import type { FetchAdminControlsResponse } from '../code_assist/types.ts';
import { getCodeAssistServer } from '../code_assist/codeAssist.ts';
import type { Experiments } from '../code_assist/experiments/experiments.ts';
import { AgentRegistry } from '../agents/index.ts';
import { setGlobalProxy } from '../util/fetch.ts';
// Moved implementation details out of Config to avoid circularity if possible
// For now, using direct imports from tools
import { DelegateToAgentTool } from '../tools/delegate-to-agent.ts';
import { DELEGATE_TO_AGENT_TOOL_NAME } from '../tools/tool-names.ts';
import { getExperiments } from '../code_assist/experiments/experiments.ts';
import { ExperimentFlags } from '../code_assist/experiments/flagNames.ts';
import { debugLogger } from '../util/debugLogger.ts';
import { SkillManager, type SkillDefinition } from '../skills/skillManager.ts';
import { startupProfiler } from '../telemetry/startupProfiler.ts';
import type { AgentDefinition, AgentSettings } from '../agents/index.ts';
import { fetchAdminControls } from '../code_assist/admin/admin_controls.ts';
...
import type { FileFilteringOptions } from './constants.ts';
import {
...
} from '../util/extensionLoader.ts';
import { McpClientManager } from '../tools/mcp-client-manager.ts';
import type { EnvironmentSanitizationConfig } from '../services/environmentSanitization.ts';
...
export class Config {
  ...
  async createToolRegistry(): Promise<ToolRegistry> {
    ...
    registerCoreTool(MemorySearchTool);
    registerCoreTool(BrowserTool);
    registerCoreTool(CodeSandboxTool);
    registerCoreTool(SendMessageTool);
    registerCoreTool(TavilySearchTool);
    registerCoreTool(ExaSearchTool);
    registerCoreTool(DuckDuckGoSearchTool);
    registerCoreTool(FirecrawlTool);
...
export namespace Config {
  ...
  export const Info = z.object({
    mcp: z.record(z.string(), z.union([Mcp, z.object({ enabled: z.boolean() })])).optional(),
