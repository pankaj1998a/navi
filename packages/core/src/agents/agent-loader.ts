...
import { isValidToolName } from '../tools/tool-names.ts';
import { FRONTMATTER_REGEX } from '../prompts/index.ts';
 ...
 */
export interface FrontmatterBaseAgentDefinition {
  name: string;
  display_name?: string;
}

export interface FrontmatterLocalAgentDefinition
...
export interface FrontmatterRemoteAgentDefinition
  extends FrontmatterBaseAgentDefinition {
  kind: 'remote';
  description?: string;
...
export type FrontmatterAgentDefinition =
