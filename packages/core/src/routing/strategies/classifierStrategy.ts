...
import { resolveClassifierModel } from '../../config/models.ts';
import { createUserContent, Type } from '@google/genai';
import type { Config } from '../../config/config.ts';
import {
  isFunctionCall,
  isFunctionResponse,
} from '../../util/messageInspectors.ts';
...
*User Prompt:* "Read the contents of 'package.tson'."
*Your JSON Output:*
{
...
*User Prompt:* "What is the best way to rename the variable 'data' to 'userData' in 'src/utils.ts'?"
*Your JSON Output:*
{
