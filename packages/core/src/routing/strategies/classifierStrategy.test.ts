...
import { ClassifierStrategy } from './classifierStrategy.ts';
...
import type { ResolvedModelConfig } from '../../services/modelConfigService.ts';
import { debugLogger } from '../../util/debugLogger.ts';

vi.mock('../../core/baseLlmClient.ts');
vi.mock('../../util/promptIdContext.ts');
