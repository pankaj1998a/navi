...
import { ensureProcessMetadata } from "../util/navi-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    ...
    attributes: {
      ...
      "navi.client": Flag.NAVI_CLIENT,
      "navi.process_role": processMetadata.processRole,
      "navi.run_id": processMetadata.runID,
