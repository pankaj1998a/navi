...
vi.mock('../services/shellExecutionService.ts', () => ({
...
vi.mock('crypto');
vi.mock('../util/summarizer.ts');

import { initializeShellParsers } from '../util/shell-utils.ts';
...
import * as summarizer from '../util/summarizer.ts';
import { ToolErrorType } from './tool-error.ts';
import { ToolConfirmationOutcome } from './tools.ts';
import { OUTPUT_UPDATE_INTERVAL_MS } from './shell.ts';
