...
import type { ConfigParameters } from '../config/config.ts';
import { Config } from '../config/config.ts';
import { ApprovalMode } from '../policy/types.ts';

import { ToolRegistry, DiscoveredTool } from './tool-registry.ts';
import { DISCOVERED_TOOL_PREFIX } from './tool-names.ts';
...
import { MockTool } from '../test-utils/mock-tool.ts';
...
vi.mock('@modelcontextprotocol/sdk/client/sse.ts', () => {
