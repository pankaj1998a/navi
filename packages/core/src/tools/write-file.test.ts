...
import type { WriteFileToolParams } from './write-file.ts';
import { getCorrectedFileContent, WriteFileTool } from './write-file.ts';
...
import { ToolConfirmationOutcome } from './tools.ts';
import { type EditToolParams } from './edit.ts';
...
import type { CorrectedEditResult } from '../util/editCorrector.ts';
import {
  ensureCorrectEdit,
  ensureCorrectFileContent,
} from '../util/editCorrector.ts';
import { StandardFileSystemService } from '../services/fileSystemService.ts';
import type { DiffUpdateResult } from '../ide/ide-client.ts';
import { IdeClient } from '../ide/ide-client.ts';
import { WorkspaceContext } from '../util/workspaceContext.ts';
import {
  createMockMessageBus,
  getMockMessageBusInstance,
} from '../test-utils/mock-message-bus.ts';

const rootDir = path.resolve(os.tmpdir(), 'gemini-cli-test-root');

// --- MOCKS ---
vi.mock('../core/client.ts');
vi.mock('../util/editCorrector.ts');
