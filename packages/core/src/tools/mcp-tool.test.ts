...
import { DiscoveredMCPTool, generateValidName } from './mcp-tool.ts'; // Added getStringifiedResultForDisplay
import type { ToolResult } from './tools.ts';
import { ToolConfirmationOutcome } from './tools.ts'; // Added ToolConfirmationOutcome
