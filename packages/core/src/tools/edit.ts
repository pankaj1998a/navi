...
import { isNodeError } from '../util/errors.ts';
import type { Config } from '../config/config.ts';
import { ApprovalMode } from '../policy/types.ts';

import { DEFAULT_DIFF_OPTIONS, getDiffStat } from './diffOptions.ts';
import {
  type ModifiableDeclarativeTool,
  type ModifyContext,
} from './modifiable-tool.ts';
import { IdeClient } from '../ide/ide-client.ts';
import { FixLLMEditWithInstruction } from '../util/llm-edit-fixer.ts';
import { safeLiteralReplace } from '../util/textUtils.ts';
import { EditStrategyEvent } from '../telemetry/types.ts';
import { logEditStrategy } from '../telemetry/loggers.ts';
import { EditCorrectionEvent } from '../telemetry/types.ts';
import { logEditCorrectionEvent } from '../telemetry/loggers.ts';

import { correctPath } from '../util/pathCorrector.ts';
import { EDIT_TOOL_NAME, READ_FILE_TOOL_NAME } from './tool-names.ts';
