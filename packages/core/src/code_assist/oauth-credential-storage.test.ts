...
import { OAuthCredentialStorage } from './oauth-credential-storage.ts';
import type { OAuthCredentials } from '../mcp/token-storage/types.ts';
...
vi.mock('../mcp/token-storage/hybrid-token-storage.ts', () => ({
...
describe('OAuthCredentialStorage', () => {
  ...
  const oldFilePath = '/mock/home/.gemini/oauth.tson';
