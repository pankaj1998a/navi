...
import { ToolCallDecision } from './tool-call-decision.ts';
import {
  EVENT_API_ERROR,
  EVENT_API_REQUEST,
  EVENT_API_RESPONSE,
...
import * as uiTelemetry from './uiTelemetry.ts';
import { makeFakeConfig } from '../test-utils/config.ts';
import { ClearcutLogger } from './clearcut-logger/clearcut-logger.ts';
  ...
  describe('logCliConfiguration', () => {
    it('should log the cli configuration', () => {
      const mockConfig = {
        ...
        getOutputFormat: () => OutputFormat.tsON,
        getExtensions: () =>
          [
