...
import { EventMetadataKey } from './event-metadata-key.ts';
...
} from '../../util/safeJsonStringify.ts';
import { FixedDeque } from 'mnemonist';
import { GIT_COMMIT_INFO, CLI_VERSION } from '../../generated/git-commit.ts';
import {
  IDE_DEFINITIONS,
  detectIdeFromEnv,
  isCloudShell,
} from '../../ide/detect-ide.ts';
