...
import { makeFakeConfig } from '../test-utils/config.ts';
import { ModelRoutingEvent, AgentFinishEvent } from './types.ts';
import { AgentTerminateMode } from '@navi-ai/agents';
...
vi.mock('./telemetryAttributes.ts');

describe('Telemetry Metrics', () => {
  let initializeMetricsModule: typeof import('./metrics.ts').initializeMetrics;
  let recordTokenUsageMetricsModule: typeof import('./metrics.ts').recordTokenUsageMetrics;
  let recordFileOperationMetricModule: typeof import('./metrics.ts').recordFileOperationMetric;
  let recordChatCompressionMetricsModule: typeof import('./metrics.ts').recordChatCompressionMetrics;
  let recordModelRoutingMetricsModule: typeof import('./metrics.ts').recordModelRoutingMetrics;
  let recordStartupPerformanceModule: typeof import('./metrics.ts').recordStartupPerformance;
  let recordMemoryUsageModule: typeof import('./metrics.ts').recordMemoryUsage;
  let recordCpuUsageModule: typeof import('./metrics.ts').recordCpuUsage;
  let recordToolQueueDepthModule: typeof import('./metrics.ts').recordToolQueueDepth;
  let recordToolExecutionBreakdownModule: typeof import('./metrics.ts').recordToolExecutionBreakdown;
  let recordTokenEfficiencyModule: typeof import('./metrics.ts').recordTokenEfficiency;
  let recordApiRequestBreakdownModule: typeof import('./metrics.ts').recordApiRequestBreakdown;
  let recordPerformanceScoreModule: typeof import('./metrics.ts').recordPerformanceScore;
  let recordPerformanceRegressionModule: typeof import('./metrics.ts').recordPerformanceRegression;
  let recordBaselineComparisonModule: typeof import('./metrics.ts').recordBaselineComparison;
  let recordGenAiClientTokenUsageModule: typeof import('./metrics.ts').recordGenAiClientTokenUsage;
  let recordGenAiClientOperationDurationModule: typeof import('./metrics.ts').recordGenAiClientOperationDuration;
  let recordFlickerFrameModule: typeof import('./metrics.ts').recordFlickerFrame;
  let recordExitFailModule: typeof import('./metrics.ts').recordExitFail;
  let recordAgentRunMetricsModule: typeof import('./metrics.ts').recordAgentRunMetrics;
  let recordLinesChangedModule: typeof import('./metrics.ts').recordLinesChanged;
  let recordSlowRenderModule: typeof import('./metrics.ts').recordSlowRender;
  ...
  beforeEach(async () => {
    ...
    const { getCommonAttributes } = await import('./telemetryAttributes.ts');
    ...
    const metricsJsModule = await import('./metrics.ts');
  ...
  describe('Performance Monitoring Metrics', () => {
    ...
    describe('recordHookCallMetrics', () => {
      let recordHookCallMetricsModule: typeof import('./metrics.ts').recordHookCallMetrics;

      beforeEach(async () => {
        recordHookCallMetricsModule = (await import('./metrics.ts'))
