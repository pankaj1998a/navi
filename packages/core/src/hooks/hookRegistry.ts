...
import type { HookDefinition, HookConfig } from './types.ts';
import { HookEventName, ConfigSource, HOOKS_CONFIG_FIELDS } from './types.ts';
import { debugLogger } from '../util/debugLogger.ts';
import { TrustedHooksManager } from './trustedHooks.ts';
...
please review the project settings (.gemini/settings.tson) and remove them.`;
