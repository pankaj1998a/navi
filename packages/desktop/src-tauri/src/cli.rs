...
const CLI_INSTALL_DIR: &str = ".navi/bin";
const CLI_BINARY_NAME: &str = "navi";
...
pub fn install_cli(app: tauri::AppHandle) -> Result<String, String> {
    ...
    let temp_script = std::env::temp_dir().join("navi-install.sh");
...
pub fn create_command(app: &tauri::AppHandle, args: &str) -> Command {
    ...
    return app
        ...
        .env("navi_EXPERIMENTAL_ICON_DISCOVERY", "true")
        .env("navi_CLIENT", "desktop")
