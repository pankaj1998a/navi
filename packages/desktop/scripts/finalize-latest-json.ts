...
const releaseId = process.env.NAVI_RELEASE
if (!releaseId) throw new Error("NAVI_RELEASE is required")

const version = process.env.NAVI_VERSION
if (!version) throw new Error("NAVI_VERSION is required")
...
const macxTarGz = "navi-desktop-mac-x64.app.tar.gz"
const macaTarGz = "navi-desktop-mac-arm64.app.tar.gz"
