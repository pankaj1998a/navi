...
const SIDECAR_SERVICE_NAME = "navi server"
...
export function preferAppEnv(userDataPath: string) {
  ...
  Object.assign(process.env, {
    ...
    NAVI_EXPERIMENTAL_ICON_DISCOVERY: "true",
    NAVI_EXPERIMENTAL_FILEWATCHER: "true",
    NAVI_CLIENT: "desktop",
...
export async function checkHealth(url: string, password?: string | null): Promise<boolean> {
  ...
  if (password) {
    const auth = Buffer.from(`navi:${password}`).toString("base64")
