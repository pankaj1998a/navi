export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Navi",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Navi. ¿Quieres instalarla y reiniciar?",
