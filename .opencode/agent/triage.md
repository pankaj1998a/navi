...
Desktop application and browser-based app issues, including `navi web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core navi server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Navi Zen, Navi Go, and billing issues.
