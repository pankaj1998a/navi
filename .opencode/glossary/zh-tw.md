...
- PR #13942: https://github.com/anomalyco/navi/pull/13942

## Do Not Translate (Locale Additions)

- `Navi` (preserve casing in prose; keep `navi` only when it is part of commands, package names, paths, or code)
- `Navi Zen`
- `Navi CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `navi` in prose when referring to the product name; use `Navi`
