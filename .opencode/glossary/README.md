...
Use this folder for locale-specific translation guidance that supplements `.navi/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/navi/pull/12345

## Do Not Translate (Locale Additions)

- `Navi` (preserve casing)
