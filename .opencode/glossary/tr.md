...
- PR #15835: https://github.com/anomalyco/navi/pull/15835

## Do Not Translate (Locale Additions)

- `Navi` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `navi` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Navi` in prose, `navi` only for exact technical identifiers
...
- Avoid changing `navi` to `Navi` inside commands, URLs, package names, or code literals
