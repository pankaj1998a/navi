...
- [`help wanted`](https://github.com/anomalyco/navi/issues?q=is%3Aissue%20state%3Aopen%20label%3Ahelp-wanted)
- [`good first issue`](https://github.com/anomalyco/navi/issues?q=is%3Aissue%20state%3Aopen%20label%3A%22good%20first%20issue%22)
- [`bug`](https://github.com/anomalyco/navi/issues?q=is%3Aissue%20state%3Aopen%20label%3Abug)
- [`perf`](https://github.com/anomalyco/navi/issues?q=is%3Aopen%20is%3Aissue%20label%3A%22perf%22)
...
```bash
./packages/navi/script/build.ts --single
```

Then run it with:

```bash
./packages/navi/dist/navi-<platform>/bin/navi
```
...
- `chore(navi):` maintenance in the navi package
